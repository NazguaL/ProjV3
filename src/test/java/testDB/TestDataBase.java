...
public class TestDataBase
{
    ...
    public void testWithDataBase() throws SQLException
    {
        ...
        logger.info(testData.get(175));
        database.modifyTable("INSERT INTO seleniumTable VALUES (300,'SergiiIvashko','pass')");
        logger.info(database.selectTable("select * from seleniumTable where login='ElenaEliseeva'"));
